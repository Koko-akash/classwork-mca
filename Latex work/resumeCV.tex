...
\begin{tabularx}{\linewidth}{@{}m{0.8\textwidth} m{0.2\textwidth}@{}}
{
    ...
    \small{
        \clink{
            \href{mailto:random@gmail.com}{random@gmail.com} \textbf{·} 
            {\fontdimen2\font=0.75ex +1 2345 6789} 
            \textbf{·} 
            \href{https://johnmyweb.com}{mywebsite.com}
        } \newline
        Jorhat, ASSAM
    }
} & 
{
    \hfill
    \includegraphics[width=2.8cm]{images/Crop image project.png}
}
\end{tabularx}
\begin{center}
...
% left side %
{
    \csection{EXPERIENCE}{\small
        \begin{itemize}
            % item 1 %
            \item \frcontent{META}{ Senior Software Engineer - San Fransisco, CA}{Co-designer and co-implementor of five successive generations of Google’s crawling indexing and query retrieval systems.}{August 1999 onwards}
            % item 2 %
            \item \frcontent{Old FACEBOOK}{ Senior Member of Technical Staff − Texas}{Designer and implementor of a system for retrieving and caching electronic commerce content including a crawler and custom full-text indexing system that allows flexible keyword searching of product information.}{February 1999 to August 1999}
        \end{itemize}
    }
...
% right side %
{
    ...
    \csection{HOBBIES \& INTERESTS}{\small
        ...
        \begin{tabularx}{\linewidth}{@{}*{4}{>{\centering\arraybackslash}X}@{}}
            {\centering
            \includegraphics[width=0.8cm]{resume/uiux.png}
            } &
            {\centering
            \includegraphics[width=0.8cm]{resume/psolving.png}
            } & 
            {\centering
            \includegraphics[width=0.8cm]{resume/images.png}
            } &
            {\centering
            \includegraphics[width=0.8cm]{resume/opsource.png}
            } \\
